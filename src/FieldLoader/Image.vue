    ...
    <div class="mt-1 rounded-md shadow-sm">
        ...
        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
            <div class="mt-1 sm:mt-0 sm:col-span-4">
                <UploadImages @changed="handleImages" maxError="이미지를 더 추가할 수 없습니다." :uploadMsg="field.description[$page.props.locale]" fileError="허용되지 않은 파일을 업로드 시도 했습니다." clearAll="비우기" :max="field.attributes.max" />
            </div>
        </div>
